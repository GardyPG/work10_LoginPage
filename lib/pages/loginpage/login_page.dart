...
import 'package:work10/pages/homepage/home_page.dart';
    ...
    setState(() {
      ...
      if(input.length == 6) {
        if(input == password) {
          ...
          input = '';
          pin = 0;
          return _showMaterialDialog('ERROR', 'Tnvalid PIN. Please try again.');
        }
      }
    });
  }
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              style: TextButton.styleFrom(
                textStyle:
                    GoogleFonts.kanit(fontSize: 10.0, color: Colors.black),
              ),
              onPressed: () {
                Navigator.of(context).pop();
              },
      ...
      child: Container(
        ...
        decoration: num == -2
            ...
            : BoxDecoration(
                ...
                border:
                    Border.all(width: 3.0, color: Colors.deepOrange.shade300),
                boxShadow: [
                    BoxShadow(
